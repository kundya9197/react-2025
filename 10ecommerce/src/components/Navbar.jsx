...
function Navbar() {
  return (
    // <div className='bg-gray-700 py-4 flex w-screen'>
    //   <div className=''>
    //     <img src="/Images/netflix.png" alt="image not found" className='w-1/4 items-center' />
    //   </div>
    //     <ul className='flex flex-row justify-between items-center w-full px-4'>
    //         <li>Home</li>
    //         <li>About</li>
    //         <li>Blog</li>
    //     </ul>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Goof</span>
          <img src="/Images/dogimage.png" class="h-10 " alt="Flowbite Logo" />
        </a>
