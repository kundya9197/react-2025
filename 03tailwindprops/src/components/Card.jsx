...
function Card({username, price}) { //or function Card({username})
// console.log(props.username);

    return (
        <div className=" w-60 flex flex-col rounded-xl glass  min-h-72 mt-3 ">
            <div>
                <img
            ...
            <div className="flex flex-col py-3 px-3 pb-7 -mt-4 bg-black rounded-b-xl">
                <div className="flex justify-between">
                    <p className="font-RubikBold ">{username} </p>
                    <p className="font-RubikBold">{price}</p>
                </div>
